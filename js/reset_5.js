...
!function(e) {
    ...
    return function e(n, t, r) {
        ...
        2: [ function(e, n, t) {
            ...
            n.exports = {
                ...
                handleCharge: function(e) {
                    ...
                    var l = r.stringifyData(t, n, !0), c = o + "?" + l, u = i.getExtraModule("ap");
                    r.inWeixin() && "undefined" != typeof u ? u.pay(c) : r.redirectTo(c);
                }
            };
        }, {
            "../mods": 9,
            ...
            o.store = function(e) {
                if ("undefined" != typeof localStorage && null !== localStorage) {
                    ...
                    t.app_id = e.app_id || i.app_id || "app_not_defined", t.ch_id = e.ch_id || "", t.channel = e.channel || "",
                        t.type = e.type || "", t.user_agent = c(), t.host = u(), t.time = new Date().getTime(),
                        t.puid = i.puid;
        ...
        7: [ function(e, n, t) {
            !function() {
                ...
                function c(n, t) {
                    ...
                    var r, c, u, d, s, f = 1732584193, p = -271733879, h = -1732584194, _ = 271733878;
                    for (r = 0; r < n.length; r += 16) c = f, u = p, d = h, s = _, f = i(f, p, h, _, n[r], 7, -680876936),
                        ...
                        p = l(p, h, _, f, n[r + 9], 21, -343485551), f = e(f, c), p = e(p, u), h = e(h, d),
                        _ = e(_, s);
                    return [ f, p, h, _ ];
                }
                function u(e) {
                ...
                function f(e, n) {
                    ...
                    for (a[15] = o[15] = void 0, i.length > 16 && (i = c(i, 8 * e.length)), t = 0; t < 16; t += 1) a[t] = 909522486 ^ i[t],
                        o[t] = 1549556828 ^ i[t];
                    return r = c(a.concat(d(n)), 512 + 8 * n.length), u(c(o.concat(r), 640));
                }
                function p(e) {
        ...
        8: [ function(e, n, t) {
            var r = e("./version").v, i = e("./testmode"), a = e("./callbacks"), o = e("./mods"), l = e("./stash"), c = e("./collection"), u = {}.hasOwnProperty, d = function() {
                e("./init").init();
            };
            d.prototype = {
                version: r,
                createPayment: function(e, n, t, r) {
                    ...
                    if ("undefined" == typeof d) return void a.innerCallback("fail", a.error("json_decode_fail"));
                    if (!u.call(d, "id")) return void a.innerCallback("fail", a.error("invalid_charge", "no_charge_id"));
                    if (!u.call(d, "channel")) return void a.innerCallback("fail", a.error("invalid_charge", "no_channel"));
                    u.call(d, "app") && ("string" == typeof d.app ? l.app_id = d.app : "object" == typeof d.app && "string" == typeof d.app.id && (l.app_id = d.app.id)),
                        c.report({
                            type: "pure_sdk_click",
                            channel: d.channel,
                            ch_id: d.id
                    ...
                    var s = d.channel;
                    if (!u.call(d, "credential")) return void a.innerCallback("fail", a.error("invalid_charge", "no_credential"));
                    if (!d.credential) return void a.innerCallback("fail", a.error("invalid_credential", "credential_is_undefined"));
                    if (!u.call(d.credential, s)) return void a.innerCallback("fail", a.error("invalid_credential", "credential_is_incorrect"));
                    if (!u.call(d, "livemode")) return void a.innerCallback("fail", a.error("invalid_charge", "no_livemode_field"));
                    var f = o.getChannelModule(s);
                    return "undefined" == typeof f ? (console.error('channel module "' + s + '" is undefined'),
                        void a.innerCallback("fail", a.error("invalid_channel", 'channel module "' + s + '" is undefined'))) : d.livemode === !1 ? void (u.call(f, "runTestMode") ? f.runTestMode(d) : i.runTestMode(d)) : ("undefined" != typeof t && (l.signature = t),
                    "boolean" == typeof r && (l.debug = r), void f.handleCharge(d));
                },
                setAPURL: function(e) {
                    l.APURL = e;
                }
            ...
            var r = {}.hasOwnProperty, i = n.exports = {
                ...
                request: function(e, n, t, a, o, l) {
                    ...
                    if ("undefined" != typeof c.timeout && (c.timeout = 6e3), n = n.toUpperCase(), "GET" === n && "object" == typeof t && t && (e += "?" + i.stringifyData(t, "", !0)),
                            c.open(n, e, !0), "undefined" != typeof l) for (var u in l) r.call(l, u) && c.setRequestHeader(u, l[u]);
